...
urlpatterns = [
    ...
    path('teachers/', include(([
                                   ...
                                   path('problems/<int:pk>/', teachers.ProblemUpdateView.as_view(),
                                        name='problem_change'),
                                   ...
                                   path('lectures/<int:pk>/', teachers.LectureUpdateView.as_view(),
                                        name='lecture_change'),
                                   ...
                                   path('problems/<int:pk>/solutions/', teachers.StudentSolutionsListView.as_view(),
                                        name='solution_list'),
                                   path('solutions/<int:pk>/', teachers.SolutionUpdateView.as_view(),
                                        name='solution_change'),
                                   path('solutions/<int:pk>/download/', teachers.solution_download,
